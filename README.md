...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-pz74euc.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-pz74euc.containers.anotherwebservice.com/
...
```
git clone git@github.com:B3zza/container-pz74euc.git
cd container-pz74euc
```
...
```
docker attach container-pz74euc
```
